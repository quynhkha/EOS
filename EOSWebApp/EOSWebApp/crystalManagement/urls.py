...
urlpatterns = [
    ...
    url(r'^pixel_histogram/(?P<mask_id>[0-9]+)/$', views.plot_pixel_histogram, name="plot-pixel-histogram"),
    url(r'^area_histogram/(?P<mask_id>[0-9]+)/$', views.plot_area_histogram, name="plot-area-histogram"),
